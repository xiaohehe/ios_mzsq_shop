...
@interface WebXieYiViewController ()
@property(nonatomic,strong)UIWebView *webView;
@end

@implementation WebXieYiViewController
...
-(void)ReshData{
    ...
    [analy GetMzAgreementWithTerminal_type:@"2" Block:^(id models, NSString *code, NSString *msg) {
        [self.activityVC stopAnimating];
        if (models) {
            NSString *content=[NSString stringWithFormat:@"%@",[models objectForKey:@"content"]];
            [self WebViewLoadHTMLString:[content EmptyStringByWhitespace]];
