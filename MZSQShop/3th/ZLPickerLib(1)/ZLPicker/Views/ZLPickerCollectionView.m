...
//    if ([[[NSUserDefaults standardUserDefaults]objectForKey:@"imgnum"] count]>=9) {
//        [[[UIAlertView alloc]initWithTitle:@"提示" message:@"只能选择9张图片" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil]show];
//        return;
//    }
