...
@interface ChangeTeleViewController ()<UITextFieldDelegate>

@end

@implementation ChangeTeleViewController
...
-(void)saveBtnEvent:(UIButton *)sender{
    ...
    if ([name length]<1 || ![name isValidateMobile] || [name isEmptyString]) {
        [self ShowAlertWithMessage:@"请输入手机号码"];
        return;
    }
