//
//  ShangPuLeiBieManagerViewController.m
//  MZSQShop
//
...
@interface ShangPuLeiBieManagerViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@property(nonatomic,strong)NSMutableArray *dataSource;
@property(nonatomic,strong)NSMutableDictionary *SelectedType;
@end

@implementation ShangPuLeiBieManagerViewController
...
-(void)ReshData{
    ...
    [analy MyServeTypeListWithUser_ID:[Stockpile sharedStockpile].ID Block:^(id models, NSString *code, NSString *msg) {
